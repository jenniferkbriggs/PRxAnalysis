function [out] =  runSimulatedPRx(bsnum, savename, part)
 %%% -----------------------------------------------------------------------------
% This is the main function used for calculating PRx in simulated data
% Inputs: 
% -- bsnum: How many simulated patients 
% -- savename: Filedirectory to save to
% -- part: For running multiple scripts
...
% Make heartrate frequencies across large range
HR_freq = [40:140];   %bpm
HR_freq = HR_freq/60; %bps

for bs = 1:bsnum %Run analysis over bsnum times
